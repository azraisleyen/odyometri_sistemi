...
public final class AudiometerApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        var useCase = new AudiometryUseCase(loadedConfig.config(), gateway);
        var root = new MainController(useCase, simulationMode, loadedConfig.serial().baudRate(), loadedConfig.warnings()).root();
